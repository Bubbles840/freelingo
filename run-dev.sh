...
# Fork: DeepSeek key (optional — only needed when LLM_PROVIDER=deepseek)
export DEEPSEEK_API_KEY=$(security find-generic-password -a deepseek -s freelingo -w 2>/dev/null)
